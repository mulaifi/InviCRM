...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-flash-white/50 px-4">
          ...
          <CardContent>
            ...
            <div className="relative my-6">
              <div className="absolute inset-0 flex items-center">
                <span className="w-full border-t border-brand-violet-light/50" />
              </div>
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-grey">Or continue with</span>
              </div>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-grey">
              ...
              <Link to="/register" className="text-brand-violet hover:underline">
                Create one
              </Link>
            </p>
          </CardContent>
